...
- 🔭 I'm working on a project Titled: LawLense - An AI System that would translate complex court judgements and constitution articles into simpler form using **Beautiful Soup, JupyterLab, Python Pandas, VS code, Gemini API, FastAPI, Gradio**.
